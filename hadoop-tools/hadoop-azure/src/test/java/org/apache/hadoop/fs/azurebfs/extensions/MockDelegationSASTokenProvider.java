...
import org.apache.hadoop.fs.azurebfs.services.TimeoutValuesManager;
...
public class MockDelegationSASTokenProvider implements SASTokenProvider {
  ...
  private byte[] getUserDelegationKey(String accountName, String appID, String appSecret,
    ...
    AbfsHttpOperation op = new AbfsHttpOperation(url, method, requestHeaders, new TimeoutValuesManager(null, url));
