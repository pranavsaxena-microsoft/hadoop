...
public final class TestAbfsPerfTracker {
  ...
  public void verifyDisablingOfTracker() throws Exception {
    ...
    try (AbfsPerfInfo tracker = new AbfsPerfInfo(abfsPerfTracker, "disablingCaller",
            "disablingCallee")) {
      AbfsHttpOperation op = new AbfsHttpOperation(url, "GET", new ArrayList<>(), new TimeoutValuesManager(null, url));
  ...
  public void verifyTrackingForSingletonLatencyRecords() throws Exception {
    ...
    AbfsHttpOperation httpOperation = new AbfsHttpOperation(url, "GET", new ArrayList<>(), new TimeoutValuesManager(null, url));
  ...
  public void verifyRecordingSingletonLatencyIsCheapWhenDisabled() throws Exception {
    ...
    final AbfsHttpOperation httpOperation = new AbfsHttpOperation(url, "GET", new ArrayList<>(), new TimeoutValuesManager(null, url));
  ...
  public void verifyNoExceptionOnInvalidInput() throws Exception {
    ...
    final AbfsHttpOperation httpOperation = new AbfsHttpOperation(url, "GET", new ArrayList<AbfsHttpHeader>(), new TimeoutValuesManager(null, url));
